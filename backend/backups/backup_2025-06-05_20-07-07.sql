...
-- Started on 2025-06-05 20:07:10
...
SELECT pg_catalog.setval('public.asistencias_id_a_seq', 34, true);
...
SELECT pg_catalog.setval('public.faltas_id_f_seq', 79, true);
...
SELECT pg_catalog.setval('public.login_c_id_seq', 15, true);
...
SELECT pg_catalog.setval('public.permisos_id_p_seq', 18, true);
...
-- Completed on 2025-06-05 20:07:15
